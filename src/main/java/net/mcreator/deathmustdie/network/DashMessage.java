...
import net.mcreator.deathmustdie.procedures.DashOnKeyPressedProcedure;
...
public class DashMessage {
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		DeathmustdieMod.addNetworkMessage(DashMessage.class, DashMessage::buffer, DashMessage::new, DashMessage::handler);
	}
}
